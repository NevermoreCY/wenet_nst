...
from wenet.utils.executor_v3 import Executor
...
def get_args():
    ...
    parser.add_argument('--train_data_aishell', required=True, help='aishell train data file')
    parser.add_argument('--train_data_wenetspeech', required=True, help='wenetSpeech train data file')
    parser.add_argument('--train_data_aishell2', required=True, help='aishell2 train data file')
...
def main():
    ...
    print("aishell data list = ", args.train_data_aishell)
    print("aishell2 data list = ", args.train_data_aishell2)
    ...
    train_dataset_aishell = Dataset(args.data_type, args.train_data_aishell, symbol_table,
                            train_conf_aishell, args.bpe_model, partition=True)

    train_dataset_aishell2 = Dataset(args.data_type, args.train_data_aishell2, symbol_table,
                                    train_conf_aishell, args.bpe_model, partition=True)
    ...
    train_data_loader_aishell = DataLoader(train_dataset_aishell,
                                   batch_size=None,
                                   pin_memory=args.pin_memory,
                                   num_workers=args.num_workers,
                                   prefetch_factor=args.prefetch)

    train_data_loader_aishell2 = DataLoader(train_dataset_aishell2,
                                   batch_size=None,
                                   pin_memory=args.pin_memory,
                                   num_workers=args.num_workers,
                                   prefetch_factor=args.prefetch)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        train_dataset_aishell.set_epoch(epoch)
        configs['epoch'] = epoch
        lr = optimizer.param_groups[0]['lr']
        logging.info('Epoch {} TRAIN info lr {}'.format(epoch, lr))
        
        executor.train(model, optimizer, scheduler, train_data_loader_aishell,train_data_loader_aishell2, train_data_loader_wenetspeech , device,
